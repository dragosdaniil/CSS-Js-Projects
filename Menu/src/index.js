...
const itemContainer = container.querySelector(".items-container");
...
function displayButtons(menuItems) {
  let categories = menuItems.reduce(
    (values, item) => {
  ...
  const buttonCategories = container.querySelectorAll(".filter-btn");

  buttonCategories.forEach((btn) => {
    btn.addEventListener("click", (event) => {
      const category = event.currentTarget.getAttribute("id");
